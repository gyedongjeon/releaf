...
-   **Content Script**:
    ...
    -   **Fix**: 2-Page View layout rewritten relative to `column-width` instead of fixed `column-count`.
        -   This naturally supports horizontal scrolling with unlimited pages and correct empty column handling.
